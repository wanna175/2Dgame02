...
public static class Global 
{
    ...
    #region 씬이름
    public const string START_SCENE = "Example_01 (st)";
    public const string LOADING_SCENE = "Example_02 (loading)";
    public const string PLAYER_SELECT_SCENE = "Example_03 (char sel)";
    public const string SCENE_NAME_04 = "Example_04 (start town)";
    public const string SCENE_NAME_05 = "Example_05 (dungeon1)";
    #endregion
